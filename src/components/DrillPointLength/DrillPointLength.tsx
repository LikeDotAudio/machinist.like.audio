      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(380px, 1fr))', gap: '25px', alignItems: 'start' }}>
        ...
        <div className="glass-panel" style={{ padding: '30px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px', paddingBottom: '15px', borderBottom: '1px solid var(--border-color)' }}>
            <h3 style={{ fontSize: '1.2rem', fontWeight: 600, color: 'var(--text-primary)', margin: 0 }}>🔻 Drill & Hole Parameters</h3>
          </div>
        ...
        <div className="glass-panel" style={{ padding: '30px', display: 'flex', flexDirection: 'column', gap: '25px', background: 'linear-gradient(145deg, rgba(15, 23, 42, 0.9) 0%, rgba(30, 41, 59, 0.6) 100%)', order: -1 }}>
          <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '15px' }}>
            ...
            <h3 style={{ fontSize: '1.4rem', fontWeight: 700, color: '#fff', marginTop: '4px', marginBottom: 0 }}>
              {mode === 'through' ? 'Required Drill Travel' : 'Programmed Drill Depth'}
            </h3>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: 'absolute', top: '8px', right: '14px', fontSize: '0.7rem', color: '#f4902c', textTransform: 'uppercase', letterSpacing: '1px', fontFamily: 'var(--font-mono)' }}>
              θ = {theta.toFixed(0)}° LIVE
            </div>
            <svg viewBox={`0 0 460 ${svgH}`} style={{ width: '100%', height: 'auto', marginTop: '10px' }}>
              <defs>
